...
Public Class Company_Outstand2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports_SUNBILLPLUS_App.Company_Outstand2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCompany_Outstand2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Company_Outstand2 = New Company_Outstand2()
        rpt.Site = Me.Site
        Return rpt
    End Function
