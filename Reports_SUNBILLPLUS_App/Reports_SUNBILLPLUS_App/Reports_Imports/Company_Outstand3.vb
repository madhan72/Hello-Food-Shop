...
Public Class Company_Outstand3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports_SUNBILLPLUS_App.Company_Outstand3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCompany_Outstand3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Company_Outstand3 = New Company_Outstand3()
        rpt.Site = Me.Site
        Return rpt
    End Function
