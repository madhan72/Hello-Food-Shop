...
Public Class Company_Outstand
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports_SUNBILLPLUS_App.Company_Outstand.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCompany_Outstand
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Company_Outstand = New Company_Outstand()
        rpt.Site = Me.Site
        Return rpt
    End Function
